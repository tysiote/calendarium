...
function loginStart() {
    resizeWindow();
    var spinner = $("#login-wait");
    var main = $("#login-other");
    main.hide();
...
function proceed(level) {
    ...
    if (url.indexOf("#admin") !== -1) window.location.href = "admin.html";else window.location.href = "index.html#" + level.toString();
}