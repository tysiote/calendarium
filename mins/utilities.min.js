...
function backToServices() {
    location.href = 'https://klient.tasr.sk/klient';
}
...
function parseStartTimeFromDate(date, no_time) {
    var temp_date = {};
    if (no_time) {
        temp_date.year = parseInt(date.split(" ")[2]);
        temp_date.month = parseMonth(date.split(" ")[1]);
        temp_date.day = parseInt(date.split(" ")[0].substring(0, date.split(" ")[0].length - 1));
        temp_date.hour = 0;
        temp_date.minute = 0;
    } else {
